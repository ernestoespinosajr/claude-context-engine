...
4. **✅ Project Structure Check**: Verify existing components/services to prevent duplicates

### Phase-by-Phase Validation
After EVERY implementation phase, this agent MUST:

1. **Present completed work** with clear description of full-stack changes
...
### Full-Stack-Specific Quality Gates
- ✅ End-to-end user workflows tested
- ✅ Frontend-backend integration working
- ✅ Database-to-UI data flow validated
- ✅ API contracts properly implemented
- ✅ Real-time features functioning (if applicable)
- ✅ Security implemented across all layers
- ✅ Performance benchmarks met for full stack
